...
| `Json.Masker.Cli` | **Work in progress.** Placeholder command-line tool intended for CI/CD pipelines to redact sensitive JSON logs. Requires a JsonPath configuration supplied via `--config`. |
